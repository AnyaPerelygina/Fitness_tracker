...
},{"./modules/about":2,"./modules/form-validate/form":4,"./modules/header/toggle":10,"./modules/modals/init-modals":11,"./modules/tabs/init-tabs.js":13,"./utils/ios-vh-fix":17,"./vendor/select/custom-select":20}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createAboutSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderAbout = document.querySelector('.about__swiper');
var buttonNext = document.querySelector('.about__button-next');
var buttonPrev = document.querySelector('.about__button-prev');
var mySwiper;
var createAboutSlider = function createAboutSlider() {
  mySwiper = new _swiper.default(sliderAbout, {
    loop: true,
    allowTouchMove: true,
    slidesPerView: 3,
    spaceBetween: 30,
...
exports.createAboutSlider = createAboutSlider;
  ...
  _createClass(Validator, [{
    ...
    value: function _customExample(parent, input) {
      ...
      if (!input.value.length) {
        ...
        parent.dataset.messageBase = "&ndash; There are ".concat(input.minLength - input.value.length, " more characters left to enter.");
        this._setItemInvalidState(parent, input);
        flag = false;
      } else if (input.value.length > input.minLength) {
        parent.dataset.messageBase = "&ndash; You entered ".concat(input.value.length - input.minLength, " extra characters");
        this._setItemInvalidState(parent, input);
        flag = false;
      } else {
